		...
		process = function() {
				...
				if(css && link.parentNode && (!xhr.status || xhr.status < 400 || xhr.status > 600)) {
					...
					if(base) {
						...
						// ponašanje URL-ova ne bi se trebali pretvarati (izdanje #19)
...
(function() {
	...
	// Zašto to radimo umjesto da ponavljamo svojstva u objektu .style? Jer Webkit se neće nad tim ponavljati.
